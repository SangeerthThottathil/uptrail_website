...
export async function generateMetadata({
  ...
  if (!programme || programme.track !== 'career') return { title: 'Programme — Uptrail' }
  return {
...
export default async function ProgrammeDetailPage({
  ...
  if (!programme || programme.track !== 'career') notFound()
  ...
  return (
    <main>
      <PageHeader
        label={`${programme.category} careers`}
        title={programme.title}
        description={programme.blurb}
        image={programme.image}
        imageAlt={`Learners on the ${programme.title} programme`}
      />

      <ProgrammeOverview programme={programme} kind="programme" />
      <CareerOutlook programme={programme} />
      <WhyChoose programme={programme} kind="programme" />
      ...
      <WhoIsItFor kind="programme" />
      <HowItWorks kind="programme" />
      <ProviderComparison />
      ...
      <PaymentOptions kind="programme" options={programme.paymentOptions} programmeSlug={programme.slug} />
